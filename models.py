...
class LibroBiblioteca(models.Model):
    ...
    editorial = models.ForeignKey(EditorialBiblioteca, to_field='nombre_editorial',
...
class Prestamo(models.Model):
    ...
    id_libro = models.ForeignKey(LibroBiblioteca, on_delete=models.CASCADE)
    ...
    id_bibliotecario = models.ForeignKey(Bibliotecario, on_delete=models.CASCADE)
...
class Multa(models.Model):
    ...
    id_socio_multado = models.ForeignKey(Socio, on_delete=models.CASCADE)
